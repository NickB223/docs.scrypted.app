...
2. [Install Scrypted from the App Store](https://apps.apple.com/us/app/scrypted/id1658171214). This link must be opened on the iOS device or search for Scrypted on the App Store.
